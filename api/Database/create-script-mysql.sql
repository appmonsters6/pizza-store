-- script to save the different sizes of pizzas
create table pizza_size_type
(
pizza_size_id int(11),
pizza_size varchar(45)
);

-- table to save different type of crusts
...
--table to save different types of cheese
...
-- table to save differnet type of sauces
create table sauce_type
(
sauce_type_id int(11),
